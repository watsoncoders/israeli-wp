<?php
/**
 * Template Name: טופס מלא הרשמה לקורס בוררים

 * Description: Full conversion of the arbitrators course form with fixed Terms section and WordPress integration.
 * Author: pablo rotem
...
<div class="container form-main-wrapper">
    ...
    <div class="col-md-12 paddingZ">
        <div class="imgytrt3">
            ...
            <h1 class="page3line pagtop">טופס הרשמה לקורס בוררים</h1>
        </div>
    </div>
    ...
    <form id="registerCourseForm" action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="post" enctype="multipart/form-data" onsubmit="return israeli_submitRegisterForm()">
        ...
        <input type="hidden" name="form_slug" value="course-102">
        <input type="hidden" name="courseName" value="טופס מלא הרשמה לקורס בוררים">
