<?php
/**
 * Template Name: טופס מלא הרשמה לקורס משולב

 * Description: Full conversion of the expert witness course form with fixed Terms section and WordPress integration.
 * Author: pablo rotem
...
/*
 * תצורת תבנית וורדפרס החדשה.
 *
 * חשוב:
 * - התבנית הזו כבר לא ניגשת למסד ה-legacy הישן.
 * - השמירה בפועל מתבצעת דרך התוסף Pablo Forms Engine.
 * - עץ הקטגוריות נטען מהטבלאות החדשות של WordPress.
 * - מחבר: pablo rotem
 */
$lang = 'HEB';
$courseId = 103;
...
/* * Define the translation array ($TIAL) used to display labels across the form.
 * This does not interact with the DB directly but prepares UI strings.
 * - by pablo rotem
 */
$TIAL = [
    ...
    'course_firstName' => 'שם פרטי', 'course_lastName' => 'שם משפחה',
    'course_mister' => 'תואר', 'course_gender' => 'מין', 'course_tz' => 'ת.ז.',
    'course_birthDate' => 'תאריך לידה', 'course_year' => 'שנה', 'course_month' => 'חודש', 'course_day' => 'יום',
    'course_serviceZone' => 'אזור שירות', 'course_dialZone' => 'אזור חיוג', 'course_otherDetails' => 'פרטים נוספים',
    'course_contact' => 'פרטי יצירת קשר', 'paraNum2' => 'ב', 'course_showDetails' => 'פרטי מידע יצירת קשר המפורטים להלן יופיעו באתר אלא אם כן תבחר לסמן שדה/ות כמוסתר/ים.',
    'course_homeAddress' => 'כתובת מגורים', 'course_contactDetails' => 'טלפונים, דוא"ל ואתר',
    'course_street' => 'רחוב', 'course_number' => 'מס בית', 'course_phoneNumber' => 'סלולרי', 'course_hide' => 'הסתר',
    'course_city' => 'עיר', 'course_homePhone' => 'טלפון בבית', 'course_zipcode' => 'מיקוד', 'course_extraPhone' => 'טלפון נוסף',
    'course_country' => 'מדינה', 'course_fax' => 'פקס', 'course_mailAddress' => 'כתובת למשלוח דואר', 'course_email' => 'דוא"ל',
    'course_hideAddress' => 'האם להסתיר את הכתובת?', 'course_website' => 'אתר אינטרנט',
    'course_socialMedia' => 'רשתות חברתיות', 'paraNum3' => 'ג',
    'course_linkedin' => 'לינקדאין', 'course_skypeName' => 'סקייפ', 'course_facebook' => 'פייסבוק', 'course_twitter' => 'טוויטר',
    ...
    'course_langs' => 'שפות', 'paraNum5' => 'ה',
    'course_language' => 'שפה', 'course_hebrew' => 'עברית', 'course_english' => 'אנגלית', 'course_arabic' => 'ערבית',
    'course_speaking' => 'דיבור', 'course_reading' => 'קריאה', 'course_writing' => 'כתיבה',
    'course_speakLevel' => 'רמת דיבור ', 'course_readingLevel' => 'רמת קריאה ', 'course_writingLevel' => 'רמת כתיבה ',
    'course_otherLanguage' => 'שפה נוספת', 'course_otherSpeaking' => 'רמת דיבור', 'course_otherReading' => 'רמת קריאה', 'course_otherWriting' => 'רמת כתיבה',
    'course_occupation' => 'עיסוק ומקצוע', 'paraNum6' => 'ו',
    'course_yourProf' => 'מקצועך', 'course_workYear' => 'שנות ותק במקצוע', 'course_currOcc' => 'עיסוק נוכחי', 'course_occArea' => 'תחום התמחות', 'course_license' => 'מספר רישיון',
    'course_experience' => 'האם הכנת חוות דעת בחמש שנים אחרונות?', 'course_specify' => 'פרט...', 'course_atCourt' => 'האם הופעת בבית משפט?',
    'course_workDetails' => 'פרטי מקום עבודה', 'paraNum7' => 'ז',
    'course_workName' => 'שם מקום העבודה', 'course_workPhone' => 'טלפון בעבודה', 'course_currYears' => 'שנות ותק בעבודה זו', 'course_workFax' => 'פקס בעבודה', 'course_workLink' => 'אתר העבודה', 'course_workAddress' => 'כתובת העבודה', 'course_workAnother' => 'סניף נוסף',
    'course_workAccess' => 'נגישות לעבודה', 'paraNum8' => 'ח',
    'course_workByBus' => 'קווי אוטובוס',
    'course_workByTrain' => 'רכבת קרובה',
    'course_workParking' => 'חניון קרוב',
    'course_workCoffee' => 'בית קפה קרוב',
    'course_workAccessable' => 'האם נגיש לנכים?', 'course_workElevator' => 'האם יש מעלית?',
    'course_memberInOrgs' => 'חברות בארגונים', 'paraNum9' => 'ט', 'course_memberInOrg' => 'שם הארגון', 'course_linkToOrg' => 'לינק לארגון',
    'course_addToCats' => 'צירוף לקטגוריות', 'paraNum10' => 'י',
    'experts' => 'עדים מומחים', 'borerim' => 'בוררים', 'megashrim' => 'מגשרים',
    'course_newCategories' => 'בקשת קטגוריה חדשה', 'paraNum11' => 'כ', 'course_elaborateCats' => 'פרט קטגוריה חסרה',
    'course_yearlyPayment' => 'תשלום', 'paraNum12' => 'ל', 
    'course_creditTotal' => 'סה"כ לתשלום', 'course_creditOwner' => 'שם בעל הכרטיס', 'course_creditNumber' => 'מספר כרטיס', 'course_creditType' => 'סוג כרטיס',
    'course_creditCVV' => '3 ספרות בגב הכרטיס', 'course_creditID' => 'ת.ז בעל הכרטיס', 'course_creditValidDate' => 'תוקף', 'course_creditValidMonth' => 'חודש', 'course_creditValidYear' => 'שנה',
    'course_invoice' => 'חשבונית', 'paraNum13' => 'מ', 'course_invoiceOnBehalf' => 'חשבונית על שם', 'course_invoiceName' => 'שם', 'course_invoiceMyHouse' => 'הבית שלי',
    'course_invoiceMyOffice' => 'המשרד שלי', 'course_invoiceToOtherAddr' => 'כתובת אחרת',
    'course_uploadPicture' => 'העלאת תמונה', 'paraNum14' => 'נ', 'course_uploadInstructions' => 'נא להעלות תמונת פנים ברורה', 'course_browse' => 'בחר קובץ', 'course_uploadConvince' => 'מומלץ להעלות תמונה',
    'course_criminal' => 'עבר פלילי', 'paraNum15' => 'ס', 'course_criminalStatement2' => 'אני מצהיר כי אין לי עבר פלילי.',
    'course_bringFriends' => 'חבר מביא חבר', 'paraNum16' => 'ע', 'course_friendName' => 'שם החבר', 'course_friendSurname' => 'שם משפחה', 'course_friendCellphone' => 'נייד', 'course_friendProf' => 'מקצוע',
    'course_finalCond' => 'תנאים והצהרות', 'paraNum17' => 'פ',
    'course_finalCond1' => 'אני מאשר את הפרטים.', 'course_finalCond2' => 'אני מסכים לתקנון.', 'course_finalCond8' => 'מאשר קבלת דיוור', 'course_finalCond10' => 'מאשר תנאי שימוש',
    'course_send' => 'שליחה והרשמה'
];

$idUniq = 0;

// =================================================================
// == 3. WORDPRESS FORM BRIDGE
// =================================================================

/*
 * גשר בין התבנית הישנה לבין התוסף החדש.
 *
 * מה החלק הזה עושה:
 * - מציג הודעת הצלחה אחרי שליחה דרך התוסף.
 * - בודק שהתוסף הדרוש פעיל.
 * - לא שומר שום מידע בעצמו.
 * - כל השמירה מתבצעת דרך admin-post.php וה-handler של התוסף.
 *
 * מחבר: pablo rotem
 */
$msg_success = '';
$pablo_submission_id = isset($_GET['submission_id']) ? (int) $_GET['submission_id'] : 0;
$pablo_form_success = isset($_GET['pablo_form_success']) && (int) $_GET['pablo_form_success'] === 1;
$pablo_forms_engine_ready = function_exists('pablo_forms_engine_render_category_tree');

if ($pablo_form_success) {
    $msg_success = 'ההרשמה התקבלה בהצלחה!';

    if ($pablo_submission_id > 0) {
        $msg_success .= ' מספר פנייה: ' . $pablo_submission_id;
    }
}
...
/* סעיף שפות - גריד מיושר, שינוי רק לאזור השפות */
.pablo-lang-head,
#formsdivs .pablo-lang-row {
    display: grid;
...
.pablo-lang-head .lang-head-cell {
    font-size: 16px;
    font-weight: bold;
    color: #333;
    text-align: center;
...
#formsdivs .pablo-lang-row .lang-cell {
    min-width: 0;
}

#formsdivs .pablo-lang-row .lang-cell::before {
    display: none !important;
    content: none !important;
}

#formsdivs .pablo-lang-row input[type="text"],
#formsdivs .pablo-lang-row select {
    width: 100%;
    height: 40px;
    min-height: 40px;
    box-sizing: border-box;
...
.pablo-lang-actions #addnewdivfield,
.pablo-lang-actions #delete12 {
    cursor: pointer;
    font-size: 18px;
    color: #FFA801;
    margin-left: 10px;
...
<div class="container form-main-wrapper">
    ...
    <?php elseif (!$pablo_forms_engine_ready): ?>
        <div class="alert alert-danger text-center">
            <h3>התוסף Pablo Forms Engine אינו פעיל או שאינו נטען.</h3>
            <p>יש להפעיל קודם את התוסף החדש כדי שטופס זה יוכל לשמור נתונים ולטעון את עץ הקטגוריות.</p>
        </div>
    <?php else: ?>
    ...
    <div class="col-md-12 paddingZ">
        <div class="imgytrt3">
            ...
            <h1 class="page3line pagtop">טופס הרשמה לקורס משולב</h1>
        </div>
    </div>
    ...
    <form id="registerCourseForm" action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="post" enctype="multipart/form-data" onsubmit="return israeli_submitRegisterForm()">
        ...
        <input type="hidden" name="form_slug" value="course-103">
        <input type="hidden" name="courseName" value="טופס מלא הרשמה לקורס משולב">
                ...
                <div class="contact-right">
                    ...
                    <script>
                        ...
                        function updateTotalYears() {
                            var count = 0;
                            if (isNumeric(jQuery("#elementarySchoolYears").val())) count += parseInt(jQuery("#elementarySchoolYears").val(), 10);
                            if (isNumeric(jQuery("#schoolYears").val())) count += parseInt(jQuery("#schoolYears").val(), 10);
                            for (var i=1; i<20; i++) {
                                if (isNumeric(jQuery("#university"+i+"Years").val())) count += parseInt(jQuery("#university"+i+"Years").val(), 10);
                            }
                    ...
                    <div class="row">
                        <p class="frm-pargrph col-md-12">פרט את ראשי התיבות של התואר והיכן נרכש יש לפרט את שם המוסד, העיר והמדינה. אם ציינת תארים, עליך לפרט ולהסביר אותם באופן שכל אדם ממוצע ושאינו קשור לתחום יבין אותם. למשל תואר DOCTOR of MEDICINE : MD ד"ר - דוקטורט ברפואה - למדתי בבולוניה, איטליה.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="contact-right">
                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-xs-12 row-grid pdht15 extra_mb_field">
                            <p>
                                <input name="fldProfession" placeholder="מקצועך" id="fldProfession" type="text">
                                <label for="fldProfession" class="hidden-section">מקצועך</label>
                            </p>
                            <p>
                                <input name="fldGeneralLongevity" placeholder="מספר שנות עבודה במקצוע" id="fldGeneralLongevity" type="number">
                                <label for="fldGeneralLongevity" class="hidden-section">מספר שנות עבודה במקצוע</label>
                            </p>
                            <p>
                                <input name="currBiz" placeholder="עיסוקך הנוכחי והגדרת תפקידך" id="currBiz" type="text">
                                <label for="currBiz" class="hidden-section">עיסוקך הנוכחי והגדרת תפקידך</label>
                            </p>
                            <p>
                                <input name="fldSpecialization" placeholder="תחום התמחות מקצועית" id="fldSpecialization" type="text">
                                <label for="fldSpecialization" class="hidden-section">תחום התמחות מקצועית</label>
                            </p>
                            <p>
                                <input name="licenseNo" placeholder="עו&quot;ד/רופא – מספר הרשיון" id="licenseNo" type="text">
                                <label for="licenseNo" class="hidden-section">עו"ד/רופא – מספר הרשיון</label>
                            </p>
                        </div>
                            ...
                            <div class="m-t-35">
                                <div class="squaredTwo checkboxset">
                                    <fieldset>
                                        ...
                                        <input value="None" id="experience1" name="experience1" type="checkbox">
                                        <label for="experience1" class="hidden-section">האם הכנת חוות דעת מקצועית בחמש השנים האחרונות?</label>
                                    </fieldset>
                                </div>
                                <label class="lablSec">האם הכנת חוות דעת מקצועית בחמש השנים האחרונות?</label>
                                <textarea id="experience2" name="experience2" class="contmil90" placeholder="ככל שהתשובה חיובית אנא פרט בשתיים שלוש שורות"></textarea>            
                            </div>
                            <div class="">
                                <div class="squaredTwo checkboxset">
                                    <fieldset>
                                        <legend class="hidden-section">checkbox </legend>
                                        <input value="None" id="experience3" name="experience3" type="checkbox">
                                        <label for="experience3" class="hidden-section">האם הופעת כעד/ה מומחה/ית בבית המשפט בחמש השנים האחרונות?</label>
                                    </fieldset>
                                </div>
                                <label class="lablSec">האם הופעת כעד/ה מומחה/ית בבית המשפט בחמש השנים האחרונות?</label>
                                <textarea id="experience4" name="experience4" class="contmil909" placeholder="ככל שהתשובה חיובית אנא פרט בשתיים שלוש שורות"></textarea>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                    </div>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12 pagespecialpara brtop">
            ...
            <div class="contcactfrom">
                <div class="contact-right">
                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-xs-12 row-grid rowpadding">
                            <input name="workplace" placeholder="שם המקום בו הינך מועסק" id="workplace" type="text">
                            <label for="workplace" class="hidden-section">שם המקום בו הינך מועסק</label>
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-12 row-grid rowpaading-1">
                            <input name="workphone" placeholder="מס טלפון בעבודה" id="workphone" type="text">
                            <label for="workphone" class="hidden-section">מס טלפון בעבודה</label>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-xs-12 row-grid rowpadding">
                            <input name="fldLongevity" placeholder="מספר שנות העבודה בעיסוקך הנוכחי" id="fldLongevity" type="number">
                            <label for="fldLongevity" class="hidden-section">מספר שנות העבודה בעיסוקך הנוכחי</label>
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-12 row-grid rowpaading-1">
                            <input name="workfax" placeholder="פקס בעבודה" id="workfax" type="text">
                            <label for="workfax" class="hidden-section">פקס בעבודה</label>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-xs-12 row-grid rowpadding">
                            <input name="workweb" placeholder="לינק לאתר מקום העבודה" id="workweb" type="text">
                            <label for="workweb" class="hidden-section">לינק לאתר מקום העבודה</label>
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-12 row-grid rowpaading-1">
                            <input name="workaddress" placeholder="כתובת מקום העבודה" id="workaddress" type="text">
                            <label for="workaddress" class="hidden-section">כתובת מקום העבודה</label>
                        </div>
                    </div>      
                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-xs-12 row-grid rowpadding">
                            <input name="workaddress1" placeholder="כתובת סניף נוסף" id="workaddress1" type="text">
                            <label for="workaddress1" class="hidden-section">כתובת סניף נוסף</label>
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-12 row-grid rowpaading-1">
                            <input name="workaddress2" placeholder="כתובת סניף נוסף" id="workaddress2" type="text">
                            <label for="workaddress2" class="hidden-section">כתובת סניף נוסף</label>
                        </div>
                    </div>      
                </div>
            </div>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12 pagespecialpara brtop">
            ...
            <div class="contcactfrom">
                <div class="contact-right">
                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-xs-12 row-grid rowpadding icon-input-block">
                            <i class="fa fa-bus ii-icon"></i> 
                            <input name="accessBuses" placeholder="מספרי קווי אוטובוס" id="accessBuses" type="text">
                            <label for="accessBuses" class="hidden-section">מספרי קווי אוטובוס</label>
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-12 row-grid rowpaading-1 icon-input-block">
                            <i class="fa fa-train ii-icon"></i> 
                            <input name="accessTrain" placeholder="תחנת רכבת קרובה" id="accessTrain" type="text">
                            <label for="accessTrain" class="hidden-section">תחנת רכבת קרובה</label>
                        </div>
                    </div>      
                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-xs-12 row-grid rowpadding icon-input-block">
                            <span class="fa-stack fa-3x ii-icon" style="font-size: 10px">
                                <i class="fa fa-square-o fa-stack-2x" style="font-size:22px"></i>
                                <strong class="fa-stack-1x icon-text" style="font-size: 12px; margin-top:1px">P</strong>
                            </span>
                            <input name="accessPark" placeholder="חניון קרוב" id="accessPark" type="text">
                            <label for="accessPark" class="hidden-section">חניון קרוב</label>
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-12 row-grid rowpaading-1 icon-input-block">
                            <i class="fa fa-coffee ii-icon"></i> 
                            <input name="accessCoffee" placeholder="בית קפה קרוב" id="accessCoffee" type="text">
                            <label for="accessCoffee" class="hidden-section">בית קפה קרוב</label>
                        </div>
                    </div>      
                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-xs-12 row-grid rowpadding">
                            <div class="squaredTwo checkboxset">
                                <fieldset>
                                    <legend class="hidden-section">checkbox </legend>
                                    <input value="None" id="accessDisabled" name="accessDisabled" type="checkbox">
                                    <label for="accessDisabled" class="hidden-section">האם הבניין מונגש לנכים?</label>
                                </fieldset>
                            </div>
                            <label class="lablSec">האם הבניין מונגש לנכים?</label>
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-12 row-grid rowpaading-1">
                            <div class="squaredTwo checkboxset">
                                <fieldset>
                                    <legend class="hidden-section">checkbox </legend>
                                    <input value="None" id="accessElevator" name="accessElevator" type="checkbox">
                                    <label for="accessElevator" class="hidden-section">האם יש מעלית בבניין?</label>
                                </fieldset>
                            </div>
                            <label class="lablSec">האם יש מעלית בבניין?</label>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12 pagespecialpara brtop">
            ...
            <div class="contcactfrom">
                <div class="contact-right">
                    <div id="orgsdivs">
                        <div class="row" id="orgfields1">
                            <div class="col-md-6 col-sm-6 col-xs-12 row-grid rowpadding">
                                <input name="org1" placeholder="חבר בארגון" id="org1" type="text">
                                <label for="org1" class="hidden-section">חבר בארגון</label>
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-12 row-grid rowpaading-1">
                                <input name="org1link" id="org1link" placeholder="לינק לאתר הארגון" type="text">
                                <label for="org1link" class="hidden-section">לינק לאתר הארגון</label>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                    </div>
                ...
                <script>
                    ...
                    function addOrg(){
                        orgvalue++;
                        var newRow = '<div class="row" id="orgfields'+orgvalue+'"><div class="col-md-6 col-sm-6 col-xs-12 row-grid rowpadding"><input name="org'+orgvalue+'" placeholder="חבר בארגון" id="org'+orgvalue+'" type="text"><label for="org'+orgvalue+'" class="hidden-section">חבר בארגון</label></div><div class="col-md-6 col-sm-6 col-xs-12 row-grid rowpaading-1"><input name="org'+orgvalue+'link" id="org'+orgvalue+'link" placeholder="לינק לאתר הארגון" type="text"><label for="org'+orgvalue+'link" class="hidden-section">לינק לאתר הארגון</label></div><div class="clearfix"></div></div>';
                        jQuery("#orgsdivs").append(newRow);
                        if(orgvalue > 1){
                            jQuery("#delete13").show();
                        }
                    }
                    function removeOrg(){
                        jQuery("#orgfields"+orgvalue).remove();
                        orgvalue--;
                        if(orgvalue == 1)
                            jQuery("#delete13").hide();
                    }
                </script>
            </div>
        </div>
                ...
                <div class="contact-right">
                    ...
                    <div class="row">
                        <div class="col-md-7 col-sm-7 col-xs-12 row-grid pdht15">
                            <?php echo pablo_forms_engine_render_category_tree(); ?>
                        </div>
                        
                        <div class="col-md-1 col-sm-1 col-xs-12 row-grid ">
                            <img src="<?php echo get_template_directory_uri(); ?>/designFiles/arrow-iconsilde.png" class="rformimg" alt="arrow-iconsilde">
                        </div>
                        
                        <div class="col-md-4 col-sm-4 col-xs-12 row-grid pdht15">
                            <div class="rltdivp widthrldiv">
                                <div class="col-md-12 col-sm-12 col-xs-12 paddingZ clRmvse"></div>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                    </div>
        ...
        <div class=" col-md-12  col-sm-12  col-xs-12 pagespecialpara brtop">
            ...
            <div class="contcactfrom">
                ...
                <div class="row">
                    <p class="registr-para"><label for="paymentOption1" class="hidden-section">12 תשלומים</label><input type="radio" name="paymentOption" id="paymentOption1" class="registr-radio" value="12" onclick="$('#totalSum').val('5940 + מע&quot;מ');$('#totalPay').val(5940)">12 תשלומים שווים ע"ס - 495 ₪ בתוספת מע"מ כחוק.</p>
                    <p class="registr-para"><label for="paymentOption2" class="hidden-section">5 תשלומים</label><input type="radio" name="paymentOption" id="paymentOption2" class="registr-radio" value="5" onclick="$('#totalSum').val('5175 + מע&quot;מ');$('#totalPay').val(5175)">5 תשלומים שווים ע"ס - 1035 ₪ בתוספת מע"מ כחוק.</p>
                    <p class="registr-para"><label for="paymentOption3" class="hidden-section">1 תשלומים</label><input type="radio" name="paymentOption" id="paymentOption3" class="registr-radio" value="1" onclick="$('#totalSum').val('4999 + מע&quot;מ');$('#totalPay').val(4999)">1 תשלומים שווים ע"ס - 4999 ₪ בתוספת מע"מ כחוק.</p>
                </div>
            </div>
        ...
        <div class=" col-md-12  col-sm-12  col-xs-12 pagespecialpara brtop ">
            ...
            <div class="contcactfrom">
                <div class="row">
                    <p class="registr-para-234 poit-mrt col-md-12 paddXsZ"> נודה לציון שמות שני מומחים הראויים לדעתך להצטרף להשתלמות/למאגר. ככל שהמלצתך תביא לרישומם (ולא קדמה להמלצתך פניה מהם/אליהם) אנו נזכה את חשבונך בהנחה בת 5% בהתאם להנחיותיך.</p>
                </div>
            </div>
            <div class="contcactfrom">
                <div class="contact-right">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12 pagespecialpara brtop brbotom">
            ...
            <div class="contcactfrom">
                <div class="contact-right">
                    ...
                    <p class="editing resigter-margin"><i class="fa fa-star font-icon-1"></i>הנהלת המכון שומרת על זכותה הבלעדית לערוך שינויים בתוכנית ההרצאות ו/או במרצים ו/או באתר הלימודים ו/או במועדים.</p>
                    <p class="editing resigter-margin"><i class="fa fa-star font-icon-1"></i>הנהלת המכון שומרת על זכותה לא להעניק תעודת סיום למי שנמצאו בלתי מתאימים במהלך הקורס, ו/או עד למועד הענקת התעודה.</p>
                    <p class="editing resigter-margin"><i class="fa fa-star font-icon-1"></i>בטול השתתפותך בהשתלמות החל מ - 14 יום לפני מועד תחילתה המשוער יחייבך בדמי בטול בסך 15%, ובתוספת של 1% לכל יום נוסף.</p>
                    ...
                    <div class="squaredthree"><fieldset><i class="fa fa-star font-icon-1"></i><legend class="hidden-section">checkbox </legend><input value="None" id="squaredthree4" name="check1" type="checkbox"><label for="squaredthree4" class="hidden-section">checkbox</label></fieldset></div>
                    ...
                    <div class="squaredthree"><fieldset><i class="fa fa-star font-icon-1"></i><legend class="hidden-section">checkbox </legend><input value="None" id="squaredthree5" name="check2" type="checkbox"><label for="squaredthree5" class="hidden-section">checkbox</label></fieldset></div>
                    <p class="editing resigter-margin htpad45 sentform">כל הפרטים שמסרתי בשאלון הרשמה זה, אמת (יאומת בתצהיר).</p>

                    <div class="squaredthree"><fieldset><i class="fa fa-star font-icon-1"></i><legend class="hidden-section">checkbox </legend><input value="None" id="squaredthree6" name="check3" type="checkbox"><label for="squaredthree6" class="hidden-section">checkbox</label></fieldset></div>
                    <p class="editing resigter-margin htpad45">הובא לידיעתי כי יהא עלי לאמת את כל האמור בשאלון זה בתצהיר חתום בפני עורך דין.</p>

                    <div class="squaredthree"><fieldset><i class="fa fa-star font-icon-1"></i><legend class="hidden-section">checkbox </legend><input value="None" id="squaredthree60" name="check8" type="checkbox"><label for="squaredthree60" class="hidden-section">checkbox</label></fieldset></div>
                    <p class="editing resigter-margin htpad45">הובא לידיעתי כי פרק הזמן לביצוע הקורס כולל השלמות חיסורים הינו עד 120 יום.</p>

                    <div class="squaredthree"><fieldset><legend class="hidden-section">checkbox </legend><input value="None" id="squaredthree8" name="check5" type="checkbox"><label for="squaredthree8" class="hidden-section">checkbox</label></fieldset></div>
                    <p class="editing resigter-margin htpad45 sentform">במידה ואדרש, אמציא לכם כל תעודה ומסמך הקשורים להשכלתי, מקצועי ועיסוקי.</p>

                    <div class="squaredthree"><fieldset><legend class="hidden-section">checkbox </legend><input value="None" id="squaredthree9" name="check6" type="checkbox"><label for="squaredthree9" class="hidden-section">checkbox</label></fieldset></div>
                    <p class="editing resigter-margin htpad45 sentform">קראתי את כללי האתיקה של המומחה ואת תקנון האתר ואני מתחייב לפעול על פיהם במידה ואצורף.</p>

                    <div class="squaredthree"><fieldset><legend class="hidden-section">checkbox </legend><input value="None" id="squaredthree7" name="check4" type="checkbox"><label for="squaredthree7" class="hidden-section">checkbox</label></fieldset></div>
                    <p class="editing resigter-margin htpad45 sentform">ברמת העיקרון אני מוכן להשתתף בהשתלמויות העשרה משפטיות שעורך המכון.</p>

                    <div class="squaredthree"><fieldset><legend class="hidden-section">checkbox </legend><input value="None" id="squaredthree10" name="check7" type="checkbox"><label for="squaredthree10" class="hidden-section">checkbox</label></fieldset></div>
...
jQuery(document).ready(function($) {
    ...
    $("#addsasa").click(function (e) {
        ...
        '<div class="col-md-12 col-sm-12" style="padding:0px;margin-top:10px;">' +
            ...
            '</div>' +
            '<div class="col-md-1 col-sm-1 col-xs-12 row-grid rowpaading-1">' +
            ...
            '</div>' +
            '<div class="col-md-2 col-sm-2 col-xs-12 row-grid pdht15">' +
