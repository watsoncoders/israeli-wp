<?php
/**
 * Template Name: טופס הרשמה מלא לקורס תמא38 פינוי בינוי מורחב
 * Description: Registration form for TAMA 38 / Pinui Binui Extended (Course 105)
 * Author: pablo rotem
...
/* תיקון ממוקד לתוויות בסעיף השכלה - מחבר: pablo rotem */
.pablo-edu-note {
...
<div class="container form-main-wrapper">
    ...
    <div class="col-md-12 paddingZ">
        <div class="imgytrt3">
            ...
            <h1 class="page3line pagtop">טופס הרשמה לקורס תמ''א 38 /פינוי בינוי מורחב</h1>
        </div>
    </div>
    ...
    <form id="registerCourseForm" action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="post" enctype="multipart/form-data" onsubmit="return israeli_submitRegisterForm()">
        ...
        <input type="hidden" name="form_slug" value="course-105">
        <input type="hidden" name="courseName" value="קורס תמ''א 38 /פינוי בינוי מורחב">
        ...
        <div class="col-md-12 pagespecialpara brtop">
            ...
            <div class="contcactfrom">
                <div class="contact-right">
                    <div class="row">
                        <div class="col-md-3 col-sm-3 col-xs-12 row-grid rowpadding"><label for="elementarySchool" class="hidden-section"><?php echo $TIAL['course_elementary']; ?></label><input name="elementarySchool" id="elementarySchool" type="text" placeholder="<?php echo $TIAL['course_elementary']; ?>"></div>
                        <div class="col-md-3 col-sm-3 col-xs-12 row-grid rowpadding"><label for="elementarySchoolCity" class="hidden-section"><?php echo $TIAL['course_place']; ?></label><input name="elementarySchoolCity" id="elementarySchoolCity" type="text" placeholder="<?php echo $TIAL['course_place']; ?>"></div>
                        <div class="col-md-2 col-sm-2 col-xs-12 row-grid rowpadding pablo-edu-note" style="padding-top: 5px; line-height: 14px; font-size: 14px;"><?php echo $TIAL['course_noPublish']; ?></div>
                        <div class="col-md-4 col-sm-4 col-xs-12 row-grid rowpaading-1"><label for="elementarySchoolYears" class="hidden-section"><?php echo $TIAL['course_years']; ?></label><input name="elementarySchoolYears" id="elementarySchoolYears" type="text" class="updateYears" placeholder="<?php echo $TIAL['course_years']; ?>"></div>
                        <div class="clearfix"></div>
                    </div>
                    <div class="row">
                        <div class="col-md-3 col-sm-3 col-xs-12 row-grid rowpadding"><label for="highSchool" class="hidden-section"><?php echo $TIAL['course_highschool']; ?></label><input name="highSchool" id="highSchool" type="text" placeholder="<?php echo $TIAL['course_highschool']; ?>"></div>
                        <div class="col-md-3 col-sm-3 col-xs-12 row-grid rowpadding"><label for="highSchoolCity" class="hidden-section"><?php echo $TIAL['course_place']; ?></label><input name="highSchoolCity" id="highSchoolCity" type="text" placeholder="<?php echo $TIAL['course_place']; ?>"></div>
                        <div class="col-md-2 col-sm-2 col-xs-12 row-grid rowpadding"><label for="highSchoolFaculty" class="hidden-section"><?php echo $TIAL['course_study']; ?></label><input name="highSchoolFaculty" id="highSchoolFaculty" type="text" placeholder="<?php echo $TIAL['course_study']; ?>"></div>
                        <div class="col-md-4 col-sm-4 col-xs-12 row-grid rowpaading-1"><label for="schoolYears" class="hidden-section"><?php echo $TIAL['course_years']; ?></label><input name="schoolYears" id="schoolYears" type="text" class="updateYears" placeholder="<?php echo $TIAL['course_years']; ?>"></div>
                        <div class="clearfix"></div>
                    </div>
                    <div class="row">
                        <div class="col-md-3 col-sm-3 col-xs-12 row-grid rowpadding"><label for="university1" class="hidden-section"><?php echo $TIAL['course_institute']; ?></label><input name="university1" id="university1" type="text" placeholder="<?php echo $TIAL['course_institute']; ?>"></div>
                        <div class="col-md-3 col-sm-3 col-xs-12 row-grid rowpadding"><label for="university1City" class="hidden-section"><?php echo $TIAL['course_place']; ?></label><input name="university1City" id="university1City" type="text" placeholder="<?php echo $TIAL['course_place']; ?>"></div>
                        <div class="col-md-2 col-sm-2 col-xs-12 row-grid rowpadding"><label for="university1Faculty" class="hidden-section"><?php echo $TIAL['course_faculty']; ?></label><input name="university1Faculty" id="university1Faculty" type="text" placeholder="<?php echo $TIAL['course_faculty']; ?>"></div>
                        <div class="col-md-1 col-sm-1 col-xs-12 row-grid rowpaading-1 pdL0"><label for="university1Years" class="hidden-section"><?php echo $TIAL['course_years']; ?></label><input name="university1Years" id="university1Years" type="text" class="updateYears" placeholder="<?php echo $TIAL['course_years_short']; ?>"></div>
                        <div class="col-md-2 col-sm-2 col-xs-12 row-grid pdL0"><label for="university1Degree" class="hidden-section"><?php echo $TIAL['course_degree']; ?></label><input name="university1Degree" id="university1Degree" type="text" placeholder="<?php echo $TIAL['course_degree']; ?>"></div>
                        <div class="col-md-1 col-sm-1 col-xs-12 row-grid pdht15"><i class="fa fa-plus icoNPlsS" id="addsasa"></i></div>
                        <div class="clearfix"></div>
                    </div>
                    <div class="row" id="itemsaa"></div>
                    <div class="row">
                        <div class="col-md-2 col-sm-2 col-xs-12 row-grid rowpadding pablo-total-years-label" style="line-height: 40px;">סה&quot;כ שנות לימוד:</div>
                        <div class="col-md-4 col-sm-4 col-xs-12 row-grid rowpaading-1"><label for="totalYears" class="hidden-section">סה&quot;כ שנות לימוד</label><input name="totalYears" id="totalYears" type="text" placeholder="סה&quot;כ שנות לימוד" disabled=""></div>
                        <div class="col-md-6 col-sm-6 col-xs-12 row-grid rowpadding"><label for="moreSchoolDetails" class="hidden-section"><?php echo $TIAL['course_other']; ?></label><input name="moreSchoolDetails" id="moreSchoolDetails" type="text" placeholder="<?php echo $TIAL['course_other']; ?>"></div>
                        <div class="clearfix"></div>
                    </div>
                    <div class="row"><p class="frm-pargrph col-md-12"><?php echo $TIAL['course_instructions']; ?></p></div>
                </div>
            </div>
        </div>
            ...
            <div class="contcactfrom">
                ...
                <div class="row">
                    <p class="registr-para">
                        ...
                        <input type="radio" name="paymentOption" id="paymentOption1" class="registr-radio" value="12" onclick="$('#totalSum').val('6300 + מע&quot;מ');$('#totalPay').val(6300)">
                        12 תשלומים שווים ע"ס - 525 ₪ בתוספת מע"מ כחוק.
                    </p>
                    <p class="registr-para">
                        <label for="paymentOption2" class="hidden-section">5 תשלומים</label>
                        <input type="radio" name="paymentOption" id="paymentOption2" class="registr-radio" value="5" onclick="$('#totalSum').val('5975 + מע&quot;מ');$('#totalPay').val(5975)">
                        5 תשלומים שווים ע"ס - 1195 ₪ בתוספת מע"מ כחוק.
                    </p>
                    <p class="registr-para">
                        <label for="paymentOption3" class="hidden-section">1 תשלומים</label>
                        <input type="radio" name="paymentOption" id="paymentOption3" class="registr-radio" value="1" onclick="$('#totalSum').val('5750 + מע&quot;מ');$('#totalPay').val(5750)">
                        1 תשלומים שווים ע"ס - 5750 ₪ בתוספת מע"מ כחוק.
                    </p>
                </div>
            </div>
