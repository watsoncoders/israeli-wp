<?php
/**
 * Template Name: טופס מלא הרשמה לקורס עדים מומחים
...
<div class="container form-main-wrapper">
    ...
    <div class="col-md-12 paddingZ">
        <div class="imgytrt3">
            ...
            <h1 class="page3line pagtop">טופס הרשמה לקורס עדים מומחים</h1>
        </div>
    </div>
    ...
    <form id="registerCourseForm" action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="post" enctype="multipart/form-data" onsubmit="return israeli_submitRegisterForm()">
        ...
        <input type="hidden" name="form_slug" value="course-101">
        <input type="hidden" name="courseName" value="טופס מלא הרשמה לקורס עדים מומחים">
        ...
        <div class="col-md-12 pagespecialpara brtop">
            ...
            <div class="contcactfrom">
                <div class="contact-right">
                    ...
                    <div class="row">
                        <div class="col-md-2 col-sm-2 col-xs-12 row-grid rowpadding pablo-total-years-label" style="line-height: 40px;">
                            סה&quot;כ שנות לימוד:
                        </div>
                        <div class="col-md-4 col-sm-4 col-xs-12 row-grid rowpaading-1">
                    ...
                    <div class="row">
                        <p class="frm-pargrph col-md-12"><?php echo $TIAL['course_instructions']; ?></p>
                    </div>
                </div>
            </div>
        </div>
